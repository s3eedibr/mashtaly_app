                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            width: 100,
                            child: ElevatedButton(
                              onPressed: () => selectWeek(2),
                              style: ButtonStyle(
                                elevation: const MaterialStatePropertyAll(0),
                                backgroundColor:
                                    MaterialStateProperty.resolveWith<Color>(
                                  (Set<MaterialState> states) {
                                    return selectedWeek == 2
                                        ? tPrimaryActionColor
                                        : tBgColor;
                                  },
                                ),
                          ...
                          SizedBox(
                            ...
                            width: 100,
                            child: ElevatedButton(
                              onPressed: () => selectWeek(3),
                              style: ButtonStyle(
                                elevation: const MaterialStatePropertyAll(0),
                                backgroundColor:
                                    MaterialStateProperty.resolveWith<Color>(
                                  (Set<MaterialState> states) {
                                    return selectedWeek == 3
                                        ? tPrimaryActionColor
                                        : tBgColor;
                                  },
                                ),
                          ...
                          SizedBox(
                            ...
                            width: 100,
                            child: ElevatedButton(
                              onPressed: () => selectWeek(4),
                              style: ButtonStyle(
                                elevation: const MaterialStatePropertyAll(0),
                                backgroundColor:
                                    MaterialStateProperty.resolveWith<Color>(
                                  (Set<MaterialState> states) {
                                    return selectedWeek == 4
                                        ? tPrimaryActionColor
                                        : tBgColor;
                                  },
                                ),
