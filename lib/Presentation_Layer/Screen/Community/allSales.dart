...
class ListAllSales extends StatefulWidget {
  const ListAllSales({Key? key}) : super(key: key);

  @override
  State<ListAllSales> createState() => _ListAllSalesState();
}

class _ListAllSalesState extends State<ListAllSales> {
  ...
  Widget buildSalesList() {
    return Padding(
      ...
      child: RefreshIndicator(
        ...
        backgroundColor: tBgColor,
        child: FutureBuilder(
          // Fetch all sale posts using the getAllSalesList() function
